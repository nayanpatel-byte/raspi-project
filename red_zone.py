...
FLIP_FRAME = False
SHOW_MASK = True   # ✅ Debug window enabled
...
def main():
    ...
    print("✅ Red Zone Detection Running | CSV logging active")
    ...
    while True:
        ...
        if SHOW_MASK:
            ...
            for z in zones:
                cv2.drawContours(mask_vis, [z[1]], -1, (0,255,0), 1)

            cv2.putText(mask_vis,
                        f"Zones:{len(zones)} RedPx:{red_pixels}",
                        (10, HEIGHT-10),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.4,
                        (255,255,255),1)

            cv2.imshow("Mask Debug", mask_vis)
    ...
    print(f"📊 CSV saved at: red_zone_log.csv")
